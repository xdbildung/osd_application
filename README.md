...
### 本地测试端口规定
**本系统固定使用端口 8090 进行本地测试和开发。**

- 🚀 **服务器端口**：`http://localhost:8090`
- 📝 **表单页面**：`http://localhost:8090`
- ⚙️ **管理面板**：`http://localhost:8090/admin`
- 📎 **文件下载**：`http://localhost:8090/public/...`
...
📝 Form available at: http://localhost:8090
⚙️  Admin panel at: http://localhost:8090/admin
📊 API endpoints:
...
### 注意事项
- **不要使用其他端口**：系统配置和测试都基于8090端口
- **端口冲突原因**：通常是因为之前的服务器实例没有正确关闭
- **开发环境**：请确保本地开发环境始终使用8090端口
